...
DetailedActivity _$DetailedActivityFromJson(Map<String, dynamic> json) =>
    DetailedActivity(
      ...
      athlete: MetaAthlete.fromJson(json['athlete'] as Map<String, dynamic>),
      ...
      sportType: $enumDecode(_$SportTypeEnumMap, json['sport_type']),
      ...
      map: PolylineMap.fromJson(json['map'] as Map<String, dynamic>),
